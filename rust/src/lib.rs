//! Windissect-generated Rust FFI bindings for RMCLIENT.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "47A091FB8280702877DE837AAB7E4619";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 2503074664;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 13] = [82, 77, 67, 76, 73, 69, 78, 84, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 2503074664 { return 0; }
