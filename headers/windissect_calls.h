...
static constexpr wchar_t module_name[13] = {0x0052, 0x004D, 0x0043, 0x004C, 0x0049, 0x0045, 0x004E, 0x0054, 0x002E, 0x0064, 0x006C, 0x006C, 0x0000};
...
if (live_timestamp != 2503074664U || rva >= image_size) return nullptr;
return base + rva;
}
